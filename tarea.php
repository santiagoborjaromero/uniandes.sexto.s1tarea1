            ...
            <div class="col-6">
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>Logitud Nombre</td>
                            <td><?PHP echo $longCadena; ?></td>
                        </tr>
                        <tr>
                            <td>Vivienda</td>
                            <td><?PHP echo "Vive en casa " . $comentarioVivienda; ?></td>
                        </tr>
                        <tr>
                            <td>Sueldo</td>
                            <td class="text-end"><?PHP echo $sueldo; ?></td>
                        </tr>
                        <tr>
                            <td>Fondos de Reserva (+)</td>
                            <td class="text-end"><?PHP echo $fondosReserva; ?></td>
                        </tr>
                        <tr>
                            <td>Aporte Seguro Social (-)</td>
                            <td class="text-end"><?PHP echo $aporteIess; ?></td>
                        </tr>
                        <tr>
                            <td>A Recibir (=)</td>
                            <td class="text-end"><?PHP echo $neto ?></td>
                        </tr>
                        <tr>
                            <td>Movimientos</td>
                            <td>
